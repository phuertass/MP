...
OBJETOS = $(BIN)/Muestra_Marcas_Fase9 $(BIN)/Marcas_Txt2Bin \
$(BIN)/Bin2text $(BIN)/Text2bin $(BIN)/RankingMarcas_Fase9
...
$(BIN)/RankingMarcas_Fase9 : $(OBJ)/RankingMarcas_Fase9.o \
$(LIB)/libMatrizMarcas.a $(LIB)/libVectorMarcas.a \
$(LIB)/libRegistroDeMarca.a
	@echo Creando II_Demo-MatrizMarcas
	$(CXX) -o $(BIN)/RankingMarcas_Fase9 \
	$(OBJ)/RankingMarcas_Fase9.o $(CXXFLAGS)  \
