...
$(BIN)/II_MezclarListasOrdenadas : \
		$(OBJ)/II_MezclarListasOrdenadas.o \
		$(LIB)/libLista.a $(LIB)/libGeneradorAleatorioEnteros.a
		@echo 
	@echo Creando : $(BIN)/II_MezclarListasOrdenadas
	@echo 
	$(CXX) -o $(BIN)/II_MezclarListasOrdenadas \
	       $(OBJ)/II_MezclarListasOrdenadas.o \
	       -L$(LIB) -lLista \
	       -lGeneradorAleatorioEnteros $(CXXFLAGS)

$(BIN)/II_Lista_Cadenas : \
		$(OBJ)/II_Lista_Cadenas.o \
		$(LIB)/libLista.a $(LIB)/libGeneradorAleatorioEnteros.a
		@echo 
	@echo Creando : $(BIN)/II_Lista_Cadenas
	@echo 
	$(CXX) -o $(BIN)/II_Lista_Cadenas \
	       $(OBJ)/II_Lista_Cadenas.o \
	       -L$(LIB) -lLista \
	       -lGeneradorAleatorioEnteros $(CXXFLAGS)
###############################################################################
...
$(OBJ)/II_MezclarListasOrdenadas.o : \
		...
		$(INCLUDE)/Lista.h $(INCLUDE)/GeneradorAleatorioEnteros.h
		@echo 
	@echo Creando : $(OBJ)/II_MezclarListasOrdenadas.o
	@echo 
	$(CXX) -c -o  $(OBJ)/II_MezclarListasOrdenadas.o\
	       $(SRC)/II_MezclarListasOrdenadas.cpp $(CXXFLAGS)

$(OBJ)/II_Lista_Cadenas.o : \
		$(SRC)/II_Lista_Cadenas.cpp \
		$(INCLUDE)/Lista.h $(INCLUDE)/GeneradorAleatorioEnteros.h
		@echo 
	@echo Creando : $(OBJ)/II_Lista_Cadenas.o
	@echo 
	$(CXX) -c -o  $(OBJ)/II_Lista_Cadenas.o\
	       $(SRC)/II_Lista_Cadenas.cpp $(CXXFLAGS)
###############################################################################
arbol :
	-@tree $(OBJ) $(BIN) $(LIB)
###############################################################################
