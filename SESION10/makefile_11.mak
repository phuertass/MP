...
OBJETOS = $(BIN)/IV_Demo-Matriz2D $(BIN)/IV_Demo-Lista


OPCIONALES = $(BIN)/IV_Demo-Pila $(BIN)/IV_Demo-Cola
...
$(BIN)/IV_Demo-Lista : \
	...
	@echo 
	$(CXX) -o $(BIN)/IV_Demo-Lista \
		 $(OBJ)/IV_Demo-Lista.o -L$(LIB) -lLista $(CXXFLAGS)

$(BIN)/IV_Demo-Matriz2D : \
              $(OBJ)/IV_Demo-Matriz2D.o \
              $(LIB)/libMatriz2D.a
	@echo 
	@echo Creando ejecutable: IV_Demo-Matriz2D
	@echo 
	$(CXX) -o $(BIN)/IV_Demo-Matriz2D \
         $(OBJ)/IV_Demo-Matriz2D.o -L$(LIB) -lMatriz2D $(CXXFLAGS)
###############################################################################
#OPCIONALES
###############################################################################
$(BIN)/IV_Demo-Pila : \
	...
	@echo 
	@echo Creando ejecutable: IV_Demo-Pila
	@echo 
	$(CXX) -o $(BIN)/IV_Demo-Pila \
         $(OBJ)/IV_Demo-Pila.o -L$(LIB) -lPila -lLista $(CXXFLAGS)

$(BIN)/IV_Demo-Cola : \
			$(OBJ)/IV_Demo-Cola.o \
              $(LIB)/libCola.a $(LIB)/libLista.a
	@echo 
	@echo Creando ejecutable: IV_Demo-Cola
	@echo 
	$(CXX) -o $(BIN)/IV_Demo-Cola \
         $(OBJ)/IV_Demo-Cola.o -L$(LIB) -lCola $(CXXFLAGS)
###############################################################################
#OBJETOS
###############################################################################
$(OBJ)/III_Demo-Secuencia.o : \
...
$(OBJ)/IV_Demo-Matriz2D.o : \
	...
	@echo
	$(CXX) -c -o $(OBJ)/IV_Demo-Matriz2D.o $(SRC)/IV_Demo-Matriz2D.cpp  \
	$(CXXFLAGS)
...
###############################################################################
$(OBJ)/IV_Demo-Pila.o : \
              $(SRC)/IV_Demo-Pila.cpp \
              $(INCLUDE)/Pila.h $(INCLUDE)/Lista.h
	@echo 
	@echo Creando objeto: IV_Demo-Pila.o
	@echo
	$(CXX) -c -o $(OBJ)/IV_Demo-Pila.o $(SRC)/IV_Demo-Pila.cpp  \
        $(CXXFLAGS) 

$(OBJ)/IV_Demo-Cola.o: \
              $(SRC)/IV_Demo-Cola.cpp \
              $(INCLUDE)/Cola.h $(INCLUDE)/Lista.h
	@echo 
	@echo Creando objeto: IV_Demo-Cola.o
	@echo
	$(CXX) -c -o $(OBJ)/IV_Demo-Cola.o $(SRC)/IV_Demo-Cola.cpp  \
    $(CXXFLAGS)
