...
class MatrizMarcas{
   ...
   public :
      ...
      */
      void OrdenarPorTiempos(const bool asc=true, int inicio=0, int fin=0);
    ...
    * @brief Ordena las marcas de la matriz por nombre
      ...
      * Por defecto asc = true
      */
      void OrdenarPorNombre(const bool asc=true, int incio=0,int fin=0);
      
      /**
      * @brief Ordena las marcas de la matriz por fecha
      */
      void OrdenarPorFecha(const bool asc=true, int inicio=0, int fin=0);
