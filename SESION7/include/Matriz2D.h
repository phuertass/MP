...
//
// Tipo básico descrito en el video dedicado a la declaracion de Matriz2D
//
// Fichero: Matriz2D.h
//
/***************************************************************************/
...
Matriz2D CreaMatriz (int nfils=0, int ncols=0, TipoBaseMatriz valor=0);
...
void Ecualiza(Matriz2D & matriz, TipoBaseMatriz valor=VALOR_DEF);
